...
///        qDebug()<<"mola:"<<molasuresi;

s01gle->setTime(sg);
if(ogleArasi<2)sg=sg.addSecs(bcfark+ctfark+molasuresi);else sg=sg.addSecs(bcfark+ctfark);s2gle->setTime(sg);
if(ogleArasi<3)sg=sg.addSecs(bcfark+ctfark+molasuresi);else sg=sg.addSecs(bcfark+ctfark);s3gle->setTime(sg);
if(ogleArasi<4)sg=sg.addSecs(bcfark+ctfark+molasuresi);else sg=sg.addSecs(bcfark+ctfark);s4gle->setTime(sg);
if(ogleArasi<5)sg=sg.addSecs(bcfark+ctfark+molasuresi);else sg=sg.addSecs(bcfark+ctfark);s5gle->setTime(sg);
if(ogleArasi<6)sg=sg.addSecs(bcfark+ctfark+molasuresi);else sg=sg.addSecs(bcfark+ctfark);s6gle->setTime(sg);
if(ogleArasi<7)sg=sg.addSecs(bcfark+ctfark+molasuresi);else sg=sg.addSecs(bcfark+ctfark);s7gle->setTime(sg);
if(ogleArasi<8)sg=sg.addSecs(bcfark+ctfark+molasuresi);else sg=sg.addSecs(bcfark+ctfark);s8gle->setTime(sg);
if(ogleArasi<9)sg=sg.addSecs(bcfark+ctfark+molasuresi);else sg=sg.addSecs(bcfark+ctfark);s9gle->setTime(sg);
if(ogleArasi<10)sg=sg.addSecs(bcfark+ctfark+molasuresi);else sg=sg.addSecs(bcfark+ctfark);s10gle->setTime(sg);
if(ogleArasi<11)sg=sg.addSecs(bcfark+ctfark+molasuresi);else sg=sg.addSecs(bcfark+ctfark);s11gle->setTime(sg);
if(ogleArasi<12)sg=sg.addSecs(bcfark+ctfark+molasuresi);else sg=sg.addSecs(bcfark+ctfark);s12gle->setTime(sg);
if(ogleArasi<13)sg=sg.addSecs(bcfark+ctfark+molasuresi);else sg=sg.addSecs(bcfark+ctfark);s13gle->setTime(sg);
if(ogleArasi<14)sg=sg.addSecs(bcfark+ctfark+molasuresi);else sg=sg.addSecs(bcfark+ctfark);s14gle->setTime(sg);

s01ble->setTime(sb);
if(ogleArasi<2)sb=sb.addSecs(bcfark+ctfark+molasuresi);else sb=sb.addSecs(bcfark+ctfark);s2ble->setTime(sb);
if(ogleArasi<3)sb=sb.addSecs(bcfark+ctfark+molasuresi);else sb=sb.addSecs(bcfark+ctfark);s3ble->setTime(sb);
if(ogleArasi<4)sb=sb.addSecs(bcfark+ctfark+molasuresi);else sb=sb.addSecs(bcfark+ctfark);s4ble->setTime(sb);
if(ogleArasi<5)sb=sb.addSecs(bcfark+ctfark+molasuresi);else sb=sb.addSecs(bcfark+ctfark);s5ble->setTime(sb);
if(ogleArasi<6)sb=sb.addSecs(bcfark+ctfark+molasuresi);else sb=sb.addSecs(bcfark+ctfark);s6ble->setTime(sb);
if(ogleArasi<7)sb=sb.addSecs(bcfark+ctfark+molasuresi);else sb=sb.addSecs(bcfark+ctfark);s7ble->setTime(sb);
if(ogleArasi<8)sb=sb.addSecs(bcfark+ctfark+molasuresi);else sb=sb.addSecs(bcfark+ctfark);s8ble->setTime(sb);
if(ogleArasi<9)sb=sb.addSecs(bcfark+ctfark+molasuresi);else sb=sb.addSecs(bcfark+ctfark);s9ble->setTime(sb);
if(ogleArasi<10)sb=sb.addSecs(bcfark+ctfark+molasuresi);else sb=sb.addSecs(bcfark+ctfark);s10ble->setTime(sb);
if(ogleArasi<11)sb=sb.addSecs(bcfark+ctfark+molasuresi);else sb=sb.addSecs(bcfark+ctfark);s11ble->setTime(sb);
if(ogleArasi<12)sb=sb.addSecs(bcfark+ctfark+molasuresi);else sb=sb.addSecs(bcfark+ctfark);s12ble->setTime(sb);
if(ogleArasi<13)sb=sb.addSecs(bcfark+ctfark+molasuresi);else sb=sb.addSecs(bcfark+ctfark);s13ble->setTime(sb);
if(ogleArasi<14)sb=sb.addSecs(bcfark+ctfark+molasuresi);else sb=sb.addSecs(bcfark+ctfark);s14ble->setTime(sb);


        s01cle->setTime(sc);
if(ogleArasi<2)sc=sc.addSecs(bcfark+ctfark+molasuresi);else sc=sc.addSecs(bcfark+ctfark);s2cle->setTime(sc);
if(ogleArasi<3)sc=sc.addSecs(bcfark+ctfark+molasuresi);else sc=sc.addSecs(bcfark+ctfark);s3cle->setTime(sc);
if(ogleArasi<4)sc=sc.addSecs(bcfark+ctfark+molasuresi);else sc=sc.addSecs(bcfark+ctfark);s4cle->setTime(sc);
if(ogleArasi<5)sc=sc.addSecs(bcfark+ctfark+molasuresi);else sc=sc.addSecs(bcfark+ctfark);s5cle->setTime(sc);
if(ogleArasi<6)sc=sc.addSecs(bcfark+ctfark+molasuresi);else sc=sc.addSecs(bcfark+ctfark);s6cle->setTime(sc);
if(ogleArasi<7)sc=sc.addSecs(bcfark+ctfark+molasuresi);else sc=sc.addSecs(bcfark+ctfark);s7cle->setTime(sc);
if(ogleArasi<8)sc=sc.addSecs(bcfark+ctfark+molasuresi);else sc=sc.addSecs(bcfark+ctfark);s8cle->setTime(sc);
if(ogleArasi<9)sc=sc.addSecs(bcfark+ctfark+molasuresi);else sc=sc.addSecs(bcfark+ctfark);s9cle->setTime(sc);
if(ogleArasi<10)sc=sc.addSecs(bcfark+ctfark+molasuresi);else sc=sc.addSecs(bcfark+ctfark);s10cle->setTime(sc);
if(ogleArasi<11)sc=sc.addSecs(bcfark+ctfark+molasuresi);else sc=sc.addSecs(bcfark+ctfark);s11cle->setTime(sc);
if(ogleArasi<12)sc=sc.addSecs(bcfark+ctfark+molasuresi);else sc=sc.addSecs(bcfark+ctfark);s12cle->setTime(sc);
if(ogleArasi<13)sc=sc.addSecs(bcfark+ctfark+molasuresi);else sc=sc.addSecs(bcfark+ctfark);s13cle->setTime(sc);
if(ogleArasi<14)sc=sc.addSecs(bcfark+ctfark+molasuresi);else sc=sc.addSecs(bcfark+ctfark);s14cle->setTime(sc);
