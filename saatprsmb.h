#ifndef SAATPRSMB_H
#define SAATPRSMB_H
QWidget *MainWindow::saatprsmb()
{

    QWidget *ayarPage=new QWidget();
    /*******************************************************/
    QStringList ayarlst=fileToList("e-zil-saatprsmb.conf");
...
/**************************************************************/
    ...
    saatUyarlaButton->setFixedSize(450, 30);
  ...
  //  ayarKaydetButton->setFlat(true);
   ...
   // auto widget = new QWidget;
    ...
    layout->addWidget(stle, 7,4,1,1);
        ...
        layout->addWidget(saatUyarlaButton, 8,1,1,4);
